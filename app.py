...
def index():
    if request.method == 'POST':
        ...
        try:
            conn=pymongo.MongoClient('mongodb+srv://rishabh012:test@review.vxvrg.mongodb.net/?retryWrites=true&w=majority')
            db = conn['crawlerDB'] # connecting to the database called crawlerDB
            ...
            #
                    ...
                    try:
                        comtag = commentboxes[i].div.div.find_all('div', {'class': 't-ZTKy'})
